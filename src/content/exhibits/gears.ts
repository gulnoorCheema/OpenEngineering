...
export const gears: Exhibit = {
  id: 'gears',
  number: '02',
  scene: 'gears',
  title: 'Gear ratios',
  subtitle: 'A little slower. A lot stronger. There’s a trade hiding in these teeth.',
  question: 'How can gears make something stronger but slower?',
  duration: '2 min',
  ...
  controls: [
    {
      id: 'ratio',
      label: 'Driver → driven teeth',
      kind: 'select',
      default: 2,
      options: [
        { label: '16 → 16 · equal', value: 1 },
        { label: '16 → 32 · reduction', value: 2 },
        { label: '16 → 48 · more reduction', value: 3 },
        { label: '32 → 16 · speed increase', value: 0.5 },
      ],
    },
    {
      id: 'speed',
  ...
  steps: [
    ...
    {
      id: 'trade-speed',
      label: '03 / A FAIR TRADE',
      title: 'Slower can mean stronger.',
      body: 'At the same contact force, a bigger output gear has a longer lever arm. It delivers more turning effect—torque—while rotating more slowly.',
      why: 'In an ideal gear pair, power stays the same. Doubling torque halves speed. Real gears lose some energy to friction and other effects.',
      experiment:
  ...
  sources: [
    {
      title: 'KHK — Gear technical reference',
      url: 'https://khkgears.net/gear-knowledge/gear-technical-reference/calculation-gear-dimensions/',
    },
    { title: 'Bartosz Ciechanowski — Gears', url: 'https://ciechanow.ski/gears/' },
  ],
  limitations:
