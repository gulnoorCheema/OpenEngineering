...
- Keep pure kinematics in `src/lib/mechanics.ts` and phase-driven effect calculations in `src/lib/presentation.ts`. Preserve moving pivots and rod/gear relationships. Exploded offsets are presentation only.
